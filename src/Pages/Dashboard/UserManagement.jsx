            ...
            {userLists ? (
              userLists.map((record, index) => (
                <tr key={index}>
                  ...
                  <td>
                  <button onClick={() => handleDelete(record.id)}><i className="fa-solid fa-trash-can"></i></button>
                  <button onClick={() => handleUpdate(record.id)}><i className="fa-solid fa-square-pen"></i></button>
                  </td>
                </tr>
              ))
            ) : (
